...
namespace TheRestaurant.Migrations
{
    ...
    [Migration("20250906081214_Init_1.0")]
            ...
            modelBuilder.Entity("TheRestaurant.Models.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2025, 9, 6, 8, 12, 13, 862, DateTimeKind.Utc).AddTicks(1440),
                            PasswordHash = "$2a$11$f7NdP6kM7MsGs3f09/eszefTigF4yWOcpI/QVbrVk7d6Thv6RyMJG",
                            UserName = "admin"
                        });
                });
