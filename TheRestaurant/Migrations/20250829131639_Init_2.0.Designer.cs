...
namespace TheRestaurant.Migrations
{
    ...
    [Migration("20250829131639_Init_2.0")]
            ...
            modelBuilder.Entity("TheRestaurant.Models.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2025, 8, 29, 13, 16, 38, 694, DateTimeKind.Utc).AddTicks(546),
                            PasswordHash = "$2a$11$vGeFo7MNZeFiedOpjlPmZORtpmURpkWjwkJjdK5bJUXtOVGSk0GQi",
                            UserName = "admin"
                        });
                });
